    ...
    <div className="mx-auto max-w-5xl px-4 py-8">
      ...
      <Tabs value={category} onValueChange={(v) => { setCategory(v); search(query, v); }}>
        <TabsList>
          ...
          <TabsTrigger value="videos"><Film className="mr-1.5 size-4" /> Videos</TabsTrigger>
          <TabsTrigger value="shorts"><Play className="mr-1.5 size-4" /> Shorts</TabsTrigger>
          <TabsTrigger value="music"><Music className="mr-1.5 size-4" /> Music</TabsTrigger>
        </TabsList>
