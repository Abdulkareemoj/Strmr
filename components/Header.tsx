...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 right-0 left-0 z-50 transition-all duration-300 ease-in-out">
      <div
        className={` ${scrolled ? "bg-background/80 shadow-md backdrop-blur-md" : ""} px-2 py-4`}
      >
